...
pub(super) trait Curve {
    ...
    fn append_mul_mod_p_inline<'c: 'a, 'a>(
...
impl Curve for Secp256k1 {
    ...
    fn append_mul_mod_p_inline<'c: 'a, 'a>(
        ...
        append_mul_mod_p_secp256k1(builder, context, location, a, b)
    }
    ...
    fn append_point_double<'c: 'a, 'a>(
        ...
        append_point_double_a_zero::<Self>(builder, context, location, p)
    }
    ...
    fn append_curve_rhs<'c: 'a, 'a>(
        ...
        // y² = x³ + 7 (a = 0).
        let x_sq = append_mul_p::<Self>(builder, context, location, x, x)?;
        let x_cu = append_mul_p::<Self>(builder, context, location, &x_sq, x)?;
        let b_limbs = pack_const_limbs(builder, context, location, &Self::B)?;
        append_add_p::<Self>(builder, context, location, &x_cu, &b_limbs)
    }
}
...
impl Curve for Secp256r1 {
    ...
    fn append_mul_mod_p_inline<'c: 'a, 'a>(
        ...
        append_mul_mod_n_barrett(builder, context, location, a, b, &Self::P)
    }
    ...
    fn append_point_double<'c: 'a, 'a>(
        ...
        append_point_double_a_neg_3::<Self>(builder, context, location, p)
    }
    ...
    fn append_curve_rhs<'c: 'a, 'a>(
        ...
        let x_sq = append_mul_p::<Self>(builder, context, location, x, x)?;
        let x_cu = append_mul_p::<Self>(builder, context, location, &x_sq, x)?;
        let three_limbs = pack_const_limbs(builder, context, location, &[3, 0, 0, 0])?;
        let three_x = append_mul_p::<Self>(builder, context, location, &three_limbs, x)?;
        let cu_minus_3x = append_sub_p::<Self>(builder, context, location, &x_cu, &three_x)?;
        let b_limbs = pack_const_limbs(builder, context, location, &Self::B)?;
        append_add_p::<Self>(builder, context, location, &cu_minus_3x, &b_limbs)
    }
}
